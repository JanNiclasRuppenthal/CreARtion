...
public class CircularRangeControlZ : MonoBehaviour
{
    ...
    void Start()
    {
        baseObject = sw.getBaseObject();
        CurrentValue = Mathf.RoundToInt(baseObject.transform.localRotation.eulerAngles.z);
    }
    ...
    void rotateX()
    {
        Vector3 v = baseObject.transform.localRotation.eulerAngles;
        baseObject.transform.localEulerAngles = new Vector3(CurrentValue, v.y,v.z);
    }
    ...
    {
        Vector3 v = baseObject.transform.localRotation.eulerAngles;
        baseObject.transform.localEulerAngles = new Vector3(v.x, CurrentValue,v.z);
    ...
    {
        Vector3 v = baseObject.transform.localRotation.eulerAngles;
        baseObject.transform.localEulerAngles = new Vector3(v.x, v.y,CurrentValue);
    }
}